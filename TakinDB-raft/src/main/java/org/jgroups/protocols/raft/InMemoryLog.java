...
public class InMemoryLog implements Log {
    ...
    public synchronized void forEach(ObjIntConsumer<LogEntry> function, int start_index, int end_index) {
        ...
        int start = Math.max(1, start_index) - first_appended,
                        end = end_index - first_appended;
    ...
    public String toString() {
        ...
        sb.append("first_appended=").append(first_appended).append(", last_appended=").append(last_appended).append(", commit_index=").append(commit_index).append(", current_term=").append(current_term);
        return sb.toString();
    }
